...
taille=journalist.length
print "\n\nCombien y a t'il de journalistes dans cet array ?\n"
print "> "
p taille

print "\n\nCombien d'handle contiennent un numero ?\n"
print "> "
numero=journalist.select { |v| v =~ /[0-9]/ }
p numero.length

print "\n\nCombien d'handle contiennent les 4 lettres du prénom aude à la suite (sans faire attention à la casse) ?\n"
print "> "
nombre=journalist.select { |v| v.downcase.include?("aude")}.length
p nombre

print "\n\nCombien commencent par une majuscule ?\n"
print "> "
nombre=journalist.select { |v| v[1]=~ /[A-Z]/}.length
p nombre

print "\n\nCombien contiennent une majuscule ?\n"
print "> "
nombre=journalist.select { |v| v=~ /[A-Z]/}.length
p nombre
...
print "> "
p journalist.sort_by { |v| v.downcase }
